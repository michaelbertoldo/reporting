export type FeatureKey = 'interactions' | 'investments' | 'funds' | 'notes' | 'lp_letters' | 'imports' | 'asks' | 'lps' | 'lp_associates' | 'lp_portal_access' | 'lp_portal' | 'lp_activity' | 'compliance' | 'deals' | 'diligence'
